...
const resultList = [
  {
    ...
    name: "호야 Hoya",
    desc: "호야는 덩굴성 식물로 나무나 바위에 붙어서 자랄 수 있는 식물이에요. 행잉플랜트로 키울수 있답니다 👍<br> 직사광선을 싫어해서 반음지에 키우기 적합해요. 무늬의 색상이 핑크색, 흰색, 연두색 등 다양하게 존재해요!<br>물은 흙이 빠삭하게 말랐을 때 흠뻑 주는게 좋아요. 여러 해 키우다 보면 예쁜 꽃도 볼 수 있답니다 🌺",
  },
  {
    num: 1,
  ...
  },
  {
    ...
    name: "아이비 Ivy",
    desc: "'헤데라'라고도 불리는 아이비는 다양한 품종이 있어요. 많은 사람들이 키우는 만큼 무난하게 잘 자라지만 갑자기 시름시름 앓는 경우도 많아요.<br>어디서든 잘 자라는 식물이라서 양지, 음지 모두 잘 자라요. 빛을 너무 못 보면 잎의 무늬가 엷어지니 적당한 빛을 보게 해주세요. 🙌<br>아이비는 더위에 약해요! 갑자기 시름시름 앓는다면 서늘한 곳으로 옮겨주세요.<br>물을 좋아하는 식물이에요. 겉 흙이 적당히 말랐을 때 물을 흠뻑 주세요.",
  },
  {
    num: 3,
  ...
  },
  {
    ...
    name: "금전수 ZZ plant",
    desc: "'돈이 들어오는 나무' 라는 뜻을 가진 금전수는 돈나무로도 불리고 있어요. 이름 덕분에 개업식, 집들이용으로 인기만점이랍니다! 👍<br>선물용으로 인기 많은 이유는 키우기 쉽기 때문이기도 해요. 어느정도의 빛이 있으면 어디에서도 잘 자라요.<br>금전수는 알뿌리 식물로, 뿌리에 물을 저장하기 때문에 물을 자주 주면 안돼요! 🙅‍♀️ 속 흙까지 말랐을 때 흠뻑 주세요.<br>금전수는 작은 화분에 심으면 뿌리 때문에 화분이 깨질 수 있어요. 키운지 오래됐다면 꼭 분갈이 해주세요!",
  },
  {
    num: 7,
  ...
  },
  {
    ...
    desc: "유칼립투스는 상쾌한 향이 나서 청량감을 느낄 수 있는 식물이에요. 종류도 700여 종이 넘고 향도 다양해요.<br>유칼립투스는 햇빛과 바람을 좋아하는 친구에요. 실내에서 키울경우 꼭 바람이 잘 통하는 곳에서 키워야 해요! ☝<br>건조에 강한 친구지만 물이 부족하면 잎이 고꾸라지고 말라요. 겉 흙이 바싹 말랐을 때 흠뻑 물 주세요.<br>유칼립투스는 배수가 중요해요. 실내에서 카운다면 통기성 좋은 토분에 심는걸 추천드려요! 👍",
  },
  {
    num: 11,
    img: "./assets/img/11.png",
    name: "스파트필름 Peace Lily",
    desc: "스파트필름은 계절마다 매력적인 흰 꽃이 피는 식물이에요. 생명력이 강해서 처음 식물을 키우는 사람에게 강력 추천하는 식물 1순위랍니다. 👍<br>꽃이 보고 싶다면 꼭 양지에서 키워야해요. 빛이 충분하지 않다면 꽃을 피울 힘이 사라져요.<br>스파트필름은 물이 부족할 때 잎이 축 쳐져요. 걱정마세요! 죽은게 아니에요! 🙌<br>잎이 쳐져있을 때 물을 흠뻑 주면 줄기가 다시 빳빳해진답니다.",
  },
  {
    num: 12,
    img: "./assets/img/12.jpg",
    name: "드라세나 마지나타 Dracaena marginata",
    desc: "드라세나 마지나타는 길게 뻗은 줄기가 매력적인 식물이에요.<br>줄기에 상처가 나면 빨갛게 수액이 흘러서 용혈수라고도 불려요. 식물엔 문제없으니 걱정마세요! 🙌<br>빛이 부족하면 잎이 노랗게 변하고 떨어져요. 실내에서 키울 땐 적당한 빛이 있어야 한답니다.<br>마지나타는 겉 흙이 충분히 말랐을 때 흠뻑 물 주는게 좋아요. 배수가 중요한 식물이니 분갈이 할 땐 흙에 난석을 섞어주는게 좋답니다. 👍",
  },
  {
    num: 13,
    img: "./assets/img/13.jpg",
    name: "루비 고무나무 Pink rubber tree",
    desc: "루비 고무나무는 수채화처럼 붉게 물든 잎이 매력적인 식물이에요. 고무나무 종류는 초보자도 쉽게 키울 수 있어서 인기도 많답니다!<br>과습에 예민해서 겉 흙이 바싹 말랐을 때 흠뻑 물주는게 좋아요. 분갈이 할 땐 난석을 섞어서 배수층을 만들어 주는걸 추천해요. 👍<br>어디서든 잘 자라는 편 이지만 적당한 빛을 보는게 좋아요. 빛을 못 보면 색이 옅어진답니다.",
  },
  {
    num: 14,
    img: "./assets/img/14.jpg",
    name: "맛상게아나 Corn plant",
    desc: "맛상게아나는 옥수수 잎을 닮았다고 Corn plant라고 불리는 식물이에요. 병충해에도 강화고 공기정화 능력도 최고에요!<br>적당한 빛만 있어도 잘 자라는 친구랍니다. 👍 실내에서 키운다면 과습에 주의해야해요.<br>물은 겉 흙이 바싹 말랐을 때, 흠뻑 주세요. 조금씩 자주 주면 웃자랄 수 있어요!",
  },
  {
    num: 15,
  ...
  },
  {
    ...
    desc: "아레카야자는 잘게 갈라진 잎 덕분에 이국적인 매력을 느낄 수 있는 식물이에요. 🌴<br>잎이 얇아서 햇빛을 바로 보게되면 끝이 탈 수 있어요. 반음지에서 키우는걸 추천합니다!<br>물이 부족하면 잎부터 줄기가 마르면서 쪼그라들어요. 겉 흙이 말랐을 때 충분히 주세요. 물을 너무 자주 준다면 잎이 노랗게 변할 수 있어요! ☝",
  },
  {
    num: 21,
    img: "./assets/img/22.jpg",
    name: "드라세나 드라코 Dracaena draco",
    desc: "드라코는 튼튼하고 길게 뻗은 줄기와 빳빳한 잎이 매력적인 식물이에요.<br>줄기에 상처가 나면 빨갛게 수액이 흘러서 용혈수라고도 불려요. 식물엔 문제없으니 걱정마세요! 🙌<br>빛이 충분하지 않으면 잎이 노랗게 변하고 떨어져요. 충분한 빛을 볼 수 있도록 해야 한답니다.<br>드라코는 겉 흙이 충분히 말랐을 때 흠뻑 물 주는게 좋아요. 배수가 중요한 식물이니 분갈이 할 땐 흙에 난석을 섞어주는게 좋답니다. 👍",
  },
  {
    num: 22,
    img: "./assets/img/21.jpg",
    name: "올리브나무 Olive Tree",
    desc: "올리브나무는 인테리어용 식물로 급부상하면서 카페에 가면 많이 볼 수 있는 식물이에요. 항상 푸른 잎을 유지하면서 열매도 맺으니 고마운 친구에요!👍<br>햇빛을 좋아해요. 빛이 부족하면 웃자라거나 잎이 크게 자란답니다.<br>물이 부족하면 잎이 동그랗게 말리고 끝이 까맣게 타요. 속 흙이 바싹 말랐을 때 충분한 물을 줘야해요.<br>가지치기는 2~3월에 해주는게 좋아요. 너무 자주하면 열매를 보기 힘들 수 있어요! ☝",
  },
  {
    num: 23,
    img: "./assets/img/23.jpg",
    name: "필로덴드론 콩고 Philodendron Congo",
    desc: "콩고는 크고 무성한 푸른 잎이 매력적인 식물이에요. 생명력이 강해서 초보자에게 강추하는 친구에요 👍<br>콩고는 천남성과라서 가끔 줄기에서 뿌리가 자랄 수 있어요. 걱정하지 마세요! 식물에겐 문제 없답니다.<br> 줄기에서 뻗어나온 뿌리가 너무 보기 싫다면? 잘라내주셔도 괜찮아요. <br>적당한 햇빛을 보는게 좋아요. 물은 겉 흙이 말랐을 때 흠뻑 주세요. 👏",
  },
];
